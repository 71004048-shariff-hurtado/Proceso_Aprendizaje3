...
/*
COMENTARIOS DEL COMPONENTE CursosDelEstudiante:

Requerimientos Cumplidos:
- ✓ Visualizar inscripciones del estudiante (función principal - HOME)
- ✓ Ver estado de cursos inscritos
- ✓ Filtrar por estado: Todos, En progreso, Completados
- ✓ Mostrar progreso de cada curso
- ✓ Opción para agregar nuevos cursos (link a catálogo)
- ✓ Usa useState para mantener tab activo
- ✓ Componente funcional reutilizable (TarjetaCurso)
- ✓ Acceso a datos mediante Context API
- ✓ Estadísticas visuales

Estructura:
- Este es el HOME de la aplicación (ruta "/")
- Similar a mi-inscripciones.html pero en React
- Usa TarjetaCurso con variante "inscripcion"
